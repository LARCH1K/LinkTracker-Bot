...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The column <code>LINKS.value</code>.
     */
    public final TableField<LinksRecord, String> VALUE =
        createField(DSL.name("value"), SQLDataType.VARCHAR(400).nullable(false), this, "");

    /**
     * The column <code>LINKS.HASHSUM</code>.
     */
    public final TableField<LinksRecord, Integer> HASHSUM =
        createField(DSL.name("HASHSUM"), SQLDataType.INTEGER, this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.INDEX_LINKS_VALUE);
    }
    ...
    public List<UniqueKey<LinksRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.UNIQUE_VALUE);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super Long, ? super String, ? super Integer, ? super LocalDate, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function4<? super Long, ? super String, ? super Integer, ? super LocalDate, ? extends U> from
    ) {
